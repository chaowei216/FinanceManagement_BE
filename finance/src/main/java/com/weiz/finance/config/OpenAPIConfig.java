...
public class OpenAPIConfig {
    ...
    public OpenAPI customOpenAPI(
            @Value("${open.ai.title}") String title,
            @Value("${open.ai.version}") String version,
            @Value("${open.ai.description}") String description
    ) {
        return new OpenAPI()
                .info(new Info()
                        .title(title)
    ...
    public GroupedOpenApi groupedOpenApi() {
        return GroupedOpenApi.builder()
                .group("api-service")
                .packagesToScan("com.weiz.finance.controller")
                .build();
    }
}
